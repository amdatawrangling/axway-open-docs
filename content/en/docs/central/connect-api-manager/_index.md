...
* (Optional) An Amplify Central environment. See [Create an environment](/docs/central/connect-api-manager/gateway-administation/#to-install-the-dockerized-traceability-agent)
